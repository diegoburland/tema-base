...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
			...
			wp_enqueue_style('AOS-style', get_template_directory_uri(). '/assets/css/aos.min.css');
			wp_enqueue_style( 'style-custom', get_template_directory_uri() . '/style.css');
			wp_enqueue_style( 'style-responsive', get_template_directory_uri() . '/responsive.css', '', '1.0', 'screen and (max-width: 768px)');
			...
			wp_enqueue_script('jquery-theme', get_template_directory_uri() . '/assets/js/jquery.min.js','','1.0',  true);
			wp_enqueue_script('bootstrap-js', get_template_directory_uri() . '/assets/js/bootstrap.min.js','','1.0',  true);
			wp_enqueue_script('AOS-js', get_template_directory_uri() . '/assets/js/aos.min.js','','1.0',  true);
			wp_enqueue_script('custom', get_template_directory_uri() . '/custom.js','','1.0',  true);
